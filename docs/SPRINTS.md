...
| 56 | In progress | Человечный диалог: персона, тон, возражения, без handoff оператору |
| 57 | Planned | RAG v2: порог релевантности, rerank, честное «не знаю», диагностика в ЛК |
| 58 | Planned | Жизненный цикл обучения: переиндекс, удаление страниц, инкрементальный краул |
| 59 | Planned | Извлечение лидов 2.0: LLM + regex, умный момент запроса, частичные лиды |
| 60 | Planned | Дедупликация лидов: склейка по visitor/телефону, привязка диалога |
