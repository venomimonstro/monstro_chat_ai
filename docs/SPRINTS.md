...
| 61 | Done | Память диалога: полный транскрипт, возврат посетителя, список в ЛК |
| 62 | Done | Конверсионные триггеры: проактивный чат по времени/скроллу/exit intent |
| 63 | Done | Quality Loop: 👍/👎, regression-тесты промптов, лог плохих ответов |
...
| 79 | Done | Стабильность чата и ЛК: reconnect/rate-limit, nginx WS timeout, JWT cookie isolation, parentOrigin embed |
